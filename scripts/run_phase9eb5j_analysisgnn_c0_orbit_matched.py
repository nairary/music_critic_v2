#!/usr/bin/env python3
"""Run Phase 9E-B5I C0-120K-MATCHED with the B5J finalizer repair."""
...
def _patched_runner() -> ModuleType:
    name = "music_critic_phase9eb5i_repaired_runner"
    spec = importlib.util.spec_from_file_location(name, RUNNER_PATH)
    if spec is None or spec.loader is None:
        raise RuntimeError(f"cannot load Phase 9E-B5I runner: {RUNNER_PATH}")
